...
parser.add_argument('--H', default=3, type=int,
...
def main(args):
    ...
    tr_dataset = RandomAudioDataset(200,5000,3)
    cv_dataset = RandomAudioDataset(40,5000,3)
    tr_loader = RandomDataLoader(1,5000,3,200,tr_dataset)
    cv_loader = RandomDataLoader(1,5000,3,40,cv_dataset)
